...
namespace MuHua {
	...
	public class MovementTransition {
		...
		public MovementTransition(CharacterController controller, LayerMask groundLayers) {
			this.controller = controller;
			this.groundLayers = groundLayers;
		}

		/// <summary> 移动 </summary>
		public virtual void Move(Vector2 moveDirection, float moveSpeed, float acceleration) {
